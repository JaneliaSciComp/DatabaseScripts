...
CREATE TABLE `experiment` (
  ...
  `process_flow_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `experiment_process_flow_id_fk` FOREIGN KEY (`process_flow_id`) REFERENCES `process_flow` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
