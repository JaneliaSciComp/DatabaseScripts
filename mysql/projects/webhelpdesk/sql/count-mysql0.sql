...
select count(1) from BUSINESS_ZONE;              
...
select count(1) from webhelpdesk_p.CONDITION;                  
...
select count(1) from DEPARTMENT_GROUP;           
select count(1) from DEPARTMENT_GROUP_TECH;      
...
select count(1) from LOCATION_TAX_RATE;          
...
select count(1) from TECH_CUSTOM_FIELD_SEL;      
select count(1) from TECH_GROUP;                 
select count(1) from TECH_GROUP_CLIENT;          
select count(1) from TECH_GROUP_LEVEL;           
select count(1) from TECH_GROUP_LEVEL_TECH;      
