...
DROP FUNCTION IF EXISTS mergeScoreArrayRows
//

CREATE DEFINER = sageAdmin FUNCTION mergeScoreArrayRows
...
BEGIN
  ...
  ELSE
    ...
    SET out_row_count = IF(v_data1_rows > v_data2_rows, v_data1_rows, v_data2_rows);
  END IF;
