...
CREATE DEFINER = sageAdmin PROCEDURE getSibling
...
BEGIN
  ...
  FROM cv_term_relationship parent_rel
  ...
  INNER JOIN cv_term_relationship sibling_rel ON (sibling_rel.object_id = parent.id)
